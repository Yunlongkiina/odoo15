    ...
    setup() {
        ...
        useEffect(
            () => {
                ...
                if (this.props.payload.webIcon) {
                    this.el.dataset.yunlongAppIconData = this.props.payload.webIcon;
                }
                // if (this.props.payload.webIconData) {
                //     this.el.dataset.appIconData = this.props.payload.webIconData;
                // }
            },
            () => []
        );
